...
@docs icon, size, style, margin, color, width, height, fillRule, viewBox

@docs defaultAlert, alertOptions, alertIcon

@docs defaultArrowdown, arrowDownOptions, arrowDownIcon

@docs defaultArrowleft, arrowLeftOptions, arrowLeftIcon

@docs defaultArrowright, arrowRightOptions, arrowRightIcon

@docs defaultArrowsmalldown, arrowSmallDownOptions, arrowSmallDownIcon

@docs defaultArrowsmallleft, arrowSmallLeftOptions, arrowSmallLeftIcon

@docs defaultArrowsmallright, arrowSmallRightOptions, arrowSmallRightIcon

@docs defaultArrowsmallup, arrowSmallUpOptions, arrowSmallUpIcon

@docs defaultArrowup, arrowUpOptions, arrowUpIcon

@docs defaultBeaker, beakerOptions, beakerIcon

@docs defaultBell, bellOptions, bellIcon

@docs defaultBold, boldOptions, boldIcon

@docs defaultBook, bookOptions, bookIcon

@docs defaultBookmark, bookmarkOptions, bookmarkIcon

@docs defaultBriefcase, briefcaseOptions, briefcaseIcon

@docs defaultBroadcast, broadcastOptions, broadcastIcon

@docs defaultBrowser, browserOptions, browserIcon

@docs defaultBug, bugOptions, bugIcon

@docs defaultCalendar, calendarOptions, calendarIcon

@docs defaultCheck, checkOptions, checkIcon

@docs defaultChecklist, checklistOptions, checklistIcon

@docs defaultChevrondown, chevronDownOptions, chevronDownIcon

@docs defaultChevronleft, chevronLeftOptions, chevronLeftIcon

@docs defaultChevronright, chevronRightOptions, chevronRightIcon

@docs defaultChevronup, chevronUpOptions, chevronUpIcon

@docs defaultCircleslash, circleSlashOptions, circleSlashIcon

@docs defaultCircuitboard, circuitBoardOptions, circuitBoardIcon

@docs defaultClippy, clippyOptions, clippyIcon

@docs defaultClock, clockOptions, clockIcon

@docs defaultClouddownload, cloudDownloadOptions, cloudDownloadIcon

@docs defaultCloudupload, cloudUploadOptions, cloudUploadIcon

@docs defaultCode, codeOptions, codeIcon

@docs defaultCommentdiscussion, commentDiscussionOptions, commentDiscussionIcon

@docs defaultComment, commentOptions, commentIcon

@docs defaultCreditcard, creditCardOptions, creditCardIcon

@docs defaultDash, dashOptions, dashIcon

@docs defaultDashboard, dashboardOptions, dashboardIcon

@docs defaultDatabase, databaseOptions, databaseIcon

@docs defaultDesktopdownload, desktopDownloadOptions, desktopDownloadIcon

@docs defaultDevicecameravideo, deviceCameraVideoOptions, deviceCameraVideoIcon

@docs defaultDevicecamera, deviceCameraOptions, deviceCameraIcon

@docs defaultDevicedesktop, deviceDesktopOptions, deviceDesktopIcon

@docs defaultDevicemobile, deviceMobileOptions, deviceMobileIcon

@docs defaultDiffadded, diffAddedOptions, diffAddedIcon

@docs defaultDiffignored, diffIgnoredOptions, diffIgnoredIcon

@docs defaultDiffmodified, diffModifiedOptions, diffModifiedIcon

@docs defaultDiffremoved, diffRemovedOptions, diffRemovedIcon

@docs defaultDiffrenamed, diffRenamedOptions, diffRenamedIcon

@docs defaultDiff, diffOptions, diffIcon

@docs defaultEllipses, ellipsesOptions, ellipsesIcon

@docs defaultEllipsis, ellipsisOptions, ellipsisIcon

@docs defaultEye, eyeOptions, eyeIcon

@docs defaultFilebinary, fileBinaryOptions, fileBinaryIcon

@docs defaultFilecode, fileCodeOptions, fileCodeIcon

@docs defaultFiledirectory, fileDirectoryOptions, fileDirectoryIcon

@docs defaultFilemedia, fileMediaOptions, fileMediaIcon

@docs defaultFilepdf, filePdfOptions, filePdfIcon

@docs defaultFilesubmodule, fileSubmoduleOptions, fileSubmoduleIcon

@docs defaultFilesymlinkdirectory, fileSymlinkDirectoryOptions, fileSymlinkDirectoryIcon

@docs defaultFilesymlinkfile, fileSymlinkFileOptions, fileSymlinkFileIcon

@docs defaultFiletext, fileTextOptions, fileTextIcon

@docs defaultFilezip, fileZipOptions, fileZipIcon

@docs defaultFile, fileOptions, fileIcon

@docs defaultFlame, flameOptions, flameIcon

@docs defaultFold, foldOptions, foldIcon

@docs defaultGear, gearOptions, gearIcon

@docs defaultGift, giftOptions, giftIcon

@docs defaultGistsecret, gistSecretOptions, gistSecretIcon

@docs defaultGist, gistOptions, gistIcon

@docs defaultGitbranch, gitBranchOptions, gitBranchIcon

@docs defaultGitcommit, gitCommitOptions, gitCommitIcon

@docs defaultGitcompare, gitCompareOptions, gitCompareIcon

@docs defaultGitmerge, gitMergeOptions, gitMergeIcon

@docs defaultGitpullrequest, gitPullRequestOptions, gitPullRequestIcon

@docs defaultGlobe, globeOptions, globeIcon

@docs defaultGrabber, grabberOptions, grabberIcon

@docs defaultGraph, graphOptions, graphIcon

@docs defaultHeart, heartOptions, heartIcon

@docs defaultHistory, historyOptions, historyIcon

@docs defaultHome, homeOptions, homeIcon

@docs defaultHorizontalrule, horizontalRuleOptions, horizontalRuleIcon

@docs defaultHubot, hubotOptions, hubotIcon

@docs defaultInbox, inboxOptions, inboxIcon

@docs defaultInfo, infoOptions, infoIcon

@docs defaultIssueclosed, issueClosedOptions, issueClosedIcon

@docs defaultIssueopened, issueOpenedOptions, issueOpenedIcon

@docs defaultIssuereopened, issueReopenedOptions, issueReopenedIcon

@docs defaultItalic, italicOptions, italicIcon

@docs defaultJersey, jerseyOptions, jerseyIcon

@docs defaultKey, keyOptions, keyIcon

@docs defaultKeyboard, keyboardOptions, keyboardIcon

@docs defaultLaw, lawOptions, lawIcon

@docs defaultLightbulb, lightBulbOptions, lightBulbIcon

@docs defaultLinkexternal, linkExternalOptions, linkExternalIcon

@docs defaultLink, linkOptions, linkIcon

@docs defaultListordered, listOrderedOptions, listOrderedIcon

@docs defaultListunordered, listUnorderedOptions, listUnorderedIcon

@docs defaultLocation, locationOptions, locationIcon

@docs defaultLock, lockOptions, lockIcon

@docs defaultLogogist, logoGistOptions, logoGistIcon

@docs defaultLogogithub, logoGithubOptions, logoGithubIcon

@docs defaultMailread, mailReadOptions, mailReadIcon

@docs defaultMailreply, mailReplyOptions, mailReplyIcon

@docs defaultMail, mailOptions, mailIcon

@docs defaultMarkgithub, markGithubOptions, markGithubIcon

@docs defaultMarkdown, markdownOptions, markdownIcon

@docs defaultMegaphone, megaphoneOptions, megaphoneIcon

@docs defaultMention, mentionOptions, mentionIcon

@docs defaultMilestone, milestoneOptions, milestoneIcon

@docs defaultMirror, mirrorOptions, mirrorIcon

@docs defaultMortarboard, mortarBoardOptions, mortarBoardIcon

@docs defaultMute, muteOptions, muteIcon

@docs defaultNonewline, noNewlineOptions, noNewlineIcon

@docs defaultNote, noteOptions, noteIcon

@docs defaultOctoface, octofaceOptions, octofaceIcon

@docs defaultOrganization, organizationOptions, organizationIcon

@docs defaultPackage, packageOptions, packageIcon

@docs defaultPaintcan, paintcanOptions, paintcanIcon

@docs defaultPencil, pencilOptions, pencilIcon

@docs defaultPerson, personOptions, personIcon

@docs defaultPin, pinOptions, pinIcon

@docs defaultPlug, plugOptions, plugIcon

@docs defaultPlussmall, plusSmallOptions, plusSmallIcon

@docs defaultPlus, plusOptions, plusIcon

@docs defaultPrimitivedot, primitiveDotOptions, primitiveDotIcon

@docs defaultPrimitivesquare, primitiveSquareOptions, primitiveSquareIcon

@docs defaultProject, projectOptions, projectIcon

@docs defaultPulse, pulseOptions, pulseIcon

@docs defaultQuestion, questionOptions, questionIcon

@docs defaultQuote, quoteOptions, quoteIcon

@docs defaultRadiotower, radioTowerOptions, radioTowerIcon

@docs defaultReply, replyOptions, replyIcon

@docs defaultRepoclone, repoCloneOptions, repoCloneIcon

@docs defaultRepoforcepush, repoForcePushOptions, repoForcePushIcon

@docs defaultRepoforked, repoForkedOptions, repoForkedIcon

@docs defaultRepopull, repoPullOptions, repoPullIcon

@docs defaultRepopush, repoPushOptions, repoPushIcon

@docs defaultRepo, repoOptions, repoIcon

@docs defaultRocket, rocketOptions, rocketIcon

@docs defaultRss, rssOptions, rssIcon

@docs defaultRuby, rubyOptions, rubyIcon

@docs defaultScreenfull, screenFullOptions, screenFullIcon

@docs defaultScreennormal, screenNormalOptions, screenNormalIcon

@docs defaultSearch, searchOptions, searchIcon

@docs defaultServer, serverOptions, serverIcon

@docs defaultSettings, settingsOptions, settingsIcon

@docs defaultShield, shieldOptions, shieldIcon

@docs defaultSignin, signInOptions, signInIcon

@docs defaultSignout, signOutOptions, signOutIcon

@docs defaultSmiley, smileyOptions, smileyIcon

@docs defaultSquirrel, squirrelOptions, squirrelIcon

@docs defaultStar, starOptions, starIcon

@docs defaultStop, stopOptions, stopIcon

@docs defaultSync, syncOptions, syncIcon

@docs defaultTag, tagOptions, tagIcon

@docs defaultTasklist, tasklistOptions, tasklistIcon

@docs defaultTelescope, telescopeOptions, telescopeIcon

@docs defaultTerminal, terminalOptions, terminalIcon

@docs defaultTextsize, textSizeOptions, textSizeIcon

@docs defaultThreebars, threeBarsOptions, threeBarsIcon

@docs defaultThumbsdown, thumbsdownOptions, thumbsdownIcon

@docs defaultThumbsup, thumbsupOptions, thumbsupIcon

@docs defaultTools, toolsOptions, toolsIcon

@docs defaultTrashcan, trashcanOptions, trashcanIcon

@docs defaultTriangledown, triangleDownOptions, triangleDownIcon

@docs defaultTriangleleft, triangleLeftOptions, triangleLeftIcon

@docs defaultTriangleright, triangleRightOptions, triangleRightIcon

@docs defaultTriangleup, triangleUpOptions, triangleUpIcon

@docs defaultUnfold, unfoldOptions, unfoldIcon

@docs defaultUnmute, unmuteOptions, unmuteIcon

@docs defaultUnverified, unverifiedOptions, unverifiedIcon

@docs defaultVerified, verifiedOptions, verifiedIcon

@docs defaultVersions, versionsOptions, versionsIcon

@docs defaultWatch, watchOptions, watchIcon

@docs defaultX, xOptions, xIcon

@docs defaultZap, zapOptions, zapIcon
...
@docs databasePath, defaults, desktopDownloadPath, deviceCameraPath, deviceCameraVideoPath
@docs deviceDesktopPath, deviceMobilePath, diffAddedPath, diffIgnoredPath
@docs diffModifiedPath, diffPath, diffRemovedPath, diffRenamedPath, ellipsesPath
@docs ellipsisPath, eyePath, fileBinaryPath, fileCodePath, fileDirectoryPath, fileMediaPath
@docs filePath, filePdfPath, fileSubmodulePath, fileSymlinkDirectoryPath
@docs fileSymlinkFilePath, fileTextPath, fileZipPath, flamePath, foldPath, gearPath
@docs giftPath, gistPath, gistSecretPath, gitBranchPath, gitCommitPath, gitComparePath
@docs gitMergePath, gitPullRequestPath, globePath, grabberPath, graphPath, heartPath
@docs historyPath, homePath, horizontalRulePath, hubotPath, inboxPath, infoPath
...
{-| Record for managing the options possible on an icon
-}
type alias IconOptions =
    Octicons.Internal.IconOptions


{-| Sets the defaults for all icons
-}
...
{-| Size will set both the width and height but not affect the viewBox, thereby maintaining the aspect ratio.
-}
...
{-| Sets a style attribute on the icon's SVG
-}
...
{-| Sets a margin in a style attribute on the icon's SVG
-}
...
{-| Sets the fillRule. default is evenodd
-}
...
{-| Allows overriding the default viewBox
-}
...
{-| This is the main resolver dispatch. It will render a set of IconOptions
-}
